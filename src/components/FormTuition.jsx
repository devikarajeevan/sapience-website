...
//         <h1 className='font-semibold text-2xl md:text-3xl text-center flex-grow'>Enquiry for Tuition</h1>
//       </div>
...
const FormTuition = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:3000/save-tuition-data', {
        method: 'POST',
        headers: {
        ...
        <div className='flex items-center justify-center w-full'>
          <div className='w-full md:w-[60%] shadow-xl flex flex-col my-4 rounded-xl hover:scale-105 duration-300 bg-white p-4'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col space-y-4'>
              ...
              <button type='submit' className='bg-blue-700 w-[200px] rounded-3xl font-medium mx-auto px-6 py-3 text-white'>Register</button>
            </form>
          </div>
        </div>
