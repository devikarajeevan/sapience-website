...
// const Footer = () => {
//   return (
//     <div className='max-w-[1240px] mx-auto py-14 px-14 grid lg:grid-cols-3 gap-8 text-gray-300'>
//       <div>
//         <img src={Logo} alt="Logo" className="mb-2 w-[150px] h-[150px]" />
//         <p className='text-blue-800 ml-4'>
//           <span>Empowering students with<br /> personalized<br />education at home</span>
//         </p>
  ...
  return (
    <div className='max-w-[1240px] mx-auto py-14 px-14 grid lg:grid-cols-3 gap-8 text-gray-300 text-center lg:text-left'>
      <div className="flex flex-col items-center lg:items-start">
        <img src={Logo} alt="Logo" className="mb-2 w-[150px] h-[150px]" />
        <p className='text-blue-800 md:max-w-[90%] lg:max-w-[70%] text center lg:text-left ml-0 mr-0'>
  Empowering students with personalized education at home
</p>

        <div className='flex pt-2 lg:ml-7 justify-center lg:justify-start'>
          <a href="https://www.instagram.com/sapienceeduconnect/" target="_blank" rel="noopener noreferrer">
            <FaInstagram className="lg:ml-3" color='black' size={25} />
          </a>
          <a href="https://www.linkedin.com/in/sapience-edu-connect-73719331b/" target="_blank" rel="noopener noreferrer">
            <FaLinkedinIn className="ml-3" color='black' size={25} />
          </a>
      ...
      <div className="flex mb-4">
          <a href='#' className='pb-2 text-blue-600 mr-1'>About Us |</a>
          <a href='#' className='pb-2 text-blue-600 mr-1'>Demo |</a>
          <a href='#' className='pb-2 text-blue-600'>Tuition Enquiry</a>
        </div>
        <h2 className="text-blue-700 font-bold text-3xl mt-5">Get in Touch</h2>
        <div className="text-blue-800 mt-3">
